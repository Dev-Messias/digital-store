            ...
            <Container>
                <div className="w-full flex  flex-row items-center justify-between" >
                    ...
                    <div className=" hidden md:flex w-full  flex-row items-center justify-center gap-3  " >
                        <div className="flex flex-row bg-slate-100 items-center justify-center  h-11 rounded-xl w-[60%] md:w-[55%] lg:w-[70%]  " >
                        ...
                        <div className=" flex flex-row items-center justify-center gap-6 ml-5" >
                            ...
                            <a href="#" className="bg-pink-600 px-6 font-semibold py-1 rounded-lg text-slate-50 hover:bg-pink-700 duration-200 " >Entar</a>
                        </div>
                    </div>
